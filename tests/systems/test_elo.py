...
class TestAutoCreation:
    ...
    def test_rating_auto_creates_competitor(self) -> None:
...
class TestEloMath:
    ...
    def test_home_advantage_shifts_prediction_upward(self) -> None:
    ...
    def test_predict_symmetry_without_hfa(self, r1: float, r2: float) -> None:
    ...
    def test_winner_gains_what_loser_loses(self) -> None:
    ...
    def test_draw_with_equal_ratings_is_a_noop(self) -> None:
    ...
    def test_regression_known_values(self) -> None:
    ...
    def test_regression_400_point_gap(self) -> None:
...
class TestUpdateValidation:
    ...
    def test_accepts_valid_outcome(self, outcome: float) -> None:
        elo = Elo()
